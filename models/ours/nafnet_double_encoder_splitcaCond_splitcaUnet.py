...
class UNet(nn.Module):
    def __init__(self,
        ...
        self.ending = nn.Conv2d(in_channels=width, out_channels=3, 
                               kernel_size=3, padding=1, stride=1, groups=1, bias=True)
        # self.input_ending = nn.Conv2d(in_channels=img_channel, out_channels=width, 
        #                        kernel_size=3, padding=1, stride=1, groups=1, bias=True)
...
if __name__ == '__main__':
    ...
    # input_shape = (2, 5, 64, 64)
    # out_shape = net(torch.Tensor(*input_shape)).shape
