...
def random_bbox(img_shape=(256, 256), max_bbox_shape=(128, 128), max_bbox_delta=40, min_margin=20):
    ...
    Args:
        img_shape (tuple, optional): _description_. Defaults to (256, 256).
        max_bbox_shape (tuple, optional): _description_. Defaults to (128, 128).
        max_bbox_delta (int, optional): _description_. Defaults to 40.
        min_margin (int, optional): _description_. Defaults to 20.
    ...
    if not isinstance(max_bbox_delta, max_bbox_delta):
...
def bbox2mask(img_shape, bbox, dtype='uint8'):
    ...
    mask = np.zeros((height, width, 1), dtytpe=dtype)
...
def brush_stroke_mask(img_shape,
    ...
    Args:
        img_shape (_type_): _description_
        num_vertices (tuple, optional): _description_. Defaults to (4,12).
        mean_angle (_type_, optional): _description_. Defaults to 2*math.pi/5.
        angle_range (_type_, optional): _description_. Defaults to 2*math.pi/15.
        brush_width (tuple, optional): _description_. Defaults to (12, 40).
        max_loops (int, optional): _description_. Defaults to 4.
        dtype (str, optional): _description_. Defaults to 'uint8'.
...
def random_irregular_mask(img_shape,
    ...
    Args:
        img_shape (_type_): _description_
        num_vertices (tuple, optional): _description_. Defaults to (4, 8).
        max_angle (int, optional): _description_. Defaults to 4.
        length_range (tuple, optional): _description_. Defaults to (10, 100).
        brush_width (tuple, optional): _description_. Defaults to (10, 40).
        dtype (str, optional): _description_. Defaults to 'uint8'.
...
def get_irregular_mask(img_shape, area_ratio_range=(0.15, 0.5), **kwargs):
    ...
    Args:
        img_shape (_type_): _description_
        area_ratio_range (tuple, optional): _description_. Defaults to (0.15, 0.5).
